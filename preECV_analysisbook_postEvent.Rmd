...
Event = read.csv("/Volumes/GoogleDrive-106458723681419210352/Shared drives/9. Clinical/9.6 Data reporting/AZM/PRE-ECV /ggplt/events3.csv", sep=",")
...
```{r} 
#read the data
measurements <- read.csv("/Volumes/GoogleDrive-106458723681419210352/Shared drives/9. Clinical/9.6 Data reporting/AZM/PRE-ECV /ggplt/measurements.csv", sep=";")
...
prescriptions <- read.csv("/Volumes/GoogleDrive-106458723681419210352/Shared drives/9. Clinical/9.6 Data reporting/AZM/PRE-ECV /ggplt/prescriptions.csv", sep=";")
...
## DATA RELATED TO STUDY DURATION
  df_window = df %>% rowwise() %>% filter(any(data.measurement_timestamp >Event1 & data.measurement_timestamp <= EventExclusion))
...
#HEARTRATE AF PRE-EVENT
HR_DURING_AF = subset(df_window, data.indicator== "Urgent")
HR_DURING_AF = mean(HR_DURING_AF$data.heartrate)
HR_DURING_AF_STDEV = subset(df_window, data.indicator== "Urgent")
HR_DURING_AF_STDEV = sd(HR_DURING_AF_STDEV$data.heartrate)
...
Total_days = as.numeric(EventExclusion- Event1)
...
rm(length_symptoms)
rm(length_af)
ChesptainAF = subset(df_window_red,data.indicator.af == "1")
ChesptainAF = sum(ChesptainAF$chestpains)
ChesptainnonAF = subset(df_window_red,data.indicator.af == "0")
ChesptainnonAF = sum(ChesptainnonAF$chestpains)
accuracychestpain = (ChesptainAF+(Tot_Warning_Measurements+Tot_Normal_Measurements-ChesptainnonAF))/Tot_Measurements_NoQuality
...
rm(length_symptoms)
rm(length_af)
confusedAF = subset(df_window_red,data.indicator.af == "1")
confusedAF = sum(confusedAF$confused)
confusednonAF = subset(df_window_red,data.indicator.af == "0")
confusednonAF = sum(confusednonAF$confused)
accuracyconfused = (confusedAF+(Tot_Warning_Measurements+Tot_Normal_Measurements-confusednonAF))/Tot_Measurements_NoQuality
...
fatigueAF = subset(df_window_red,data.indicator.af == "1")
fatigueAF = sum(fatigueAF$fatigue)
fatiguenonAF = subset(df_window_red,data.indicator.af == "0")
fatiguenonAF = sum(fatiguenonAF$fatigue)
fatigueaccuracy = (fatigueAF+(Tot_Warning_Measurements+Tot_Normal_Measurements-fatiguenonAF))/Tot_Measurements_NoQuality
...
lightheadedAF = subset(df_window_red,data.indicator.af == "1")
lightheadedAF = sum(lightheadedAF$fatigue)
lightheadednonAF = subset(df_window_red,data.indicator.af == "0")
lightheadednonAF = sum(lightheadednonAF$lightheaded)
lightheadedaccuracy = (lightheadedAF+(Tot_Warning_Measurements+Tot_Normal_Measurements-lightheadednonAF))/Tot_Measurements_NoQuality
...
nosymptomsdAF = subset(df_window_red,data.indicator.af == "1")
nosymptomsdAF = sum(nosymptomsdAF$no_symptoms)
nosymptomsnonAF = subset(df_window_red,data.indicator.af == "0")
nosymptomsnonAF = sum(nosymptomsnonAF$no_symptoms)
nosymptomsaccuracy = (nosymptomsdAF+(Tot_Warning_Measurements+Tot_Normal_Measurements-nosymptomsnonAF))/Tot_Measurements_NoQuality
...
otherAF = subset(df_window_red,data.indicator.af == "1")
otherAF = sum(otherAF$other)
othernonAF = subset(df_window_red,data.indicator.af == "0")
othernonAF = sum(othernonAF$other)
othersaccuracy = (otherAF+(Tot_Warning_Measurements+Tot_Normal_Measurements-othernonAF))/Tot_Measurements_NoQuality
...
shortnessAF = subset(df_window_red,data.indicator.af == "1")
shortnessAF = sum(shortnessAF$shortness_of_breath)
shortnessnonAF = subset(df_window_red,data.indicator.af == "0")
shortnessnonAF = sum(shortnessnonAF$shortness_of_breath)
shortnessaccuracy = (shortnessAF+(Tot_Warning_Measurements+Tot_Normal_Measurements-shortnessnonAF))/Tot_Measurements_NoQuality
...
write_xlsx(slide7, "/Volumes/GoogleDrive-106458723681419210352/Shared drives/9. Clinical/9.6 Data reporting/AZM/PRE-ECV /ggplt/summary_post_event.xlsx")
