...
## DATA RELATED TO STUDY DURATION
  df_window = df %>% rowwise() %>% filter(any(data.measurement_timestamp >=EventInclusion & data.measurement_timestamp < Event1))
...
Total_days = as.numeric(Event1 - EventInclusion)
...
write_xlsx(slide7, "/Volumes/GoogleDrive-106458723681419210352/Shared drives/9. Clinical/9.6 Data reporting/AZM/PRE-ECV /ggplt/summary_pre_event.xlsx")
